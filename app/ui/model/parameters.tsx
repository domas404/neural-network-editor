...
export default function Parameters() {
    return (
        <div className="h-full">
            <div className="flex flex-col py-4 px-1 w-full h-full">
                ...
                <div className="mx-1 mt-2 overflow-y-auto h-full">
                    <div className="mx-4 scrollable-container">
                        ...
                        <Param paramType="Batch Size" paramOptions={["1", "16", "24", "32", "64"]} />
                        <Param paramType="Optimizer" paramOptions={["Gradient", "SGD", "Adam", "Adagrad"]} />
