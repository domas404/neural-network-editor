            ...
            <table className="w-full h-full border-separate">
                <thead className="w-full">
                    <tr className="sticky top-0">
                        <th className={`font-semibold border-1 border-white rounded-md py-2 px-4 overflow-hidden bg-gray-200`}>
                            {columns[0]}
                        </th>
                        {
                ...
                <tbody className="">
                    {
                        dataset.map((row: DataRow, rindex) => {
                            return (
                                <tr key={`r${rindex}`}>
                                    <td className={`text-center border-1 border-white rounded-md py-1 bg-gray-100`}>
                                        {row[columns[0]]}
                                    </td>
                                    {
